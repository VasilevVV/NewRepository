...
namespace View
{
    ...
    public partial class AddDiscountForm : Form
    {
        ...
        /// Создаваемая скидка
        /// </summary>
        private DiscountBase _discountData;

        /// <summary>
        /// Созданная скидка
        /// </summary>
        public DiscountBase DiscountData
        {
            get
            {
        ...
        private void OkAddDiscountButton_Click(object sender, EventArgs e)
        {
            try
            {
                _discountData.Shop = ShopTextBox.Text;

                _discountData.DiscountValue =
        ...
        private void MakeVisible(DiscountBase discount)
        {
        ...
        private void ShowOKButton(object sender, EventArgs e)
        {
            ...
            OkAddDiscountButton.Enabled = 
                ...
                && float.TryParse(ValueTextBox.Text, out result);
        }
