    ...
    public class DiscountPeriod
    {
        ...
        private void CheckDiscountEnd(DateTime endDateTime)
        {
            if ((_dateTimeDiscountStart != DateTime.MinValue && 
                (endDateTime.Ticks < _dateTimeDiscountStart.Ticks)) ||
                (endDateTime.Ticks < _dateTimeEmergence.Ticks))
            {
        ...
        {
            if ((startDateTime.Ticks < _dateTimeEmergence.Ticks) ||
                ((startDateTime.Ticks > _dateTimeDiscountEnd.Ticks) &&
        ...
        public override string ToString()
        {
            ...
            return $"\nСрок действия с {dateTimeDiscountStart} " +
